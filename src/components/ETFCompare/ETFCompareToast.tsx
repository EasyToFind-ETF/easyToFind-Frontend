...
//             {etf.price != null
//               ? Number(etf.price).toLocaleString("ko-KR")
//               : "-"}
//           </span>
...
//       key: "netAssets",
//       render: (etf: ETFCompare) => {
//         const inHundredMillion = (
//           Number(etf.netAssets ?? 0) / 100000000
...
//         <h3 className="text-lg font-bold mt-10 mb-8">기간별 수익률 비교</h3>
