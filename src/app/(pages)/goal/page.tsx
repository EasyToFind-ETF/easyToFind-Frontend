...
export default function GoalPlannerpage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50" style={{ marginTop: 130 }}>
      <div className="max-w-7xl mx-auto">
        {/* 헤더 섹션 - ETFDetail 스타일 */}
        <div
          className="bg-[#3781fe] rounded-3xl p-6 sm:p-10 flex flex-col shadow-lg relative mx-auto w-full h-auto md:h-[400px] mb-10"
