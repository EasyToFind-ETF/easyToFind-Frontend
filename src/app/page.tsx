        ...
        >
          ...
          <div className="relative z-10 min-h-screen flex flex-col justify-center items-left w-full h-full">
            ...
            <div className="absolute bottom-14 left-1/2 transform -translate-x-1/2 z-20">
              <button 
                className="w-12 h-12 bg-white/70 backdrop-blur-sm rounded-3xl flex items-center justify-center border border-white/30 hover:bg-white/30 transition-all duration-300 animate-bounce"
                onClick={() => {
                  window.scrollTo({
          ...
          <div className="w-full max-w-7xl mx-auto mt-20 relative z-10">
            <div className="relative">
              ...
              <button
                ...
                aria-label="검색"
              >
                <svg className="w-7 h-7 mr-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <div className="w-96 flex-shrink-0">
        ...
        <div className="space-y-2">
          {[
            ...
            <div 
              key={index} 
              className={`flex items-center gap-3 p-2 rounded-3xl cursor-pointer transition-colors px-4 ${
                selectedItem === index 
                      ...
                      <div className="absolute bottom-6 right-6">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="backdrop-blur-sm rounded-xl p-3 flex justify-end">
                            <img src="/mbtiTest6.png" alt="mbti" className="w-[30%] h-[30%]" />
                          </div>
                        </div>
                      </div>
                </div>
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm">최적의 전략을 찾아보세요!</p>
                      ...
                      <div className="absolute bottom-6 right-6">
                        <div className="flex items-center space-x-3">
                        <div className="backdrop-blur-sm rounded-xl p-3 flex justify-end">
                            <img src="/mbtiTest3.png" alt="mbti" className="w-[30%] h-[30%]" />
                          </div>
                        </div>
                      </div>
                </div>
